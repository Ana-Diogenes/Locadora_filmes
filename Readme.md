...
# Sistema de Locadora de Filmes // Projeto Final Introdução à Programação
...
Toda a interface foi construída utilizando **Tkinter**, enquanto os dados são armazenados em um arquivo **CSV**.
...
A interface gráfica foi desenvolvida utilizando **Tkinter**

A navegação ocorre por meio de botões que alteram o conteúdo da janela principal.
